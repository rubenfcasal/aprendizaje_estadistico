...
Hay varios paquetes que implementan este procedimiento [e.g. `r citepkg("e1071")`, @R-e1071; `r citepkg("svmpath")`, ver @hastie2004entire], aunque se considera que el más completo es `r citepkg("kernlab")` [@kernlab2004].

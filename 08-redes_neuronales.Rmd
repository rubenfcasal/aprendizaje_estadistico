...
Para el caso de redes más complejas se puede utilizar por ejemplo el paquete `r citepkg("neuralnet")`, pero en el caso de grandes volúmenes de datos o aprendizaje profundo la recomendación sería emplear paquetes computacionalmente más eficientes (con computación en paralelo empleando CPUs o GPUs) como `r citepkg("keras", "https://keras.rstudio.com")`, `r citepkg("h2o", "https://github.com/h2oai/h2o-3")` o `r citepkg("sparlyr", "https://spark.rstudio.com/")`, entre otros.

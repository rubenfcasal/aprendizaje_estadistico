...
Podríamos estudiar el modelo final, por ejemplo, mediante el método `r cite_fun(summary.rpart, rpart)`.
...
Adicionalmente, representamos la importancia[^rpart-2] de los predictores `r cite_fig(arbolImpor)`:

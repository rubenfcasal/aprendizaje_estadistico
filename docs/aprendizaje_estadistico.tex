...
\KeywordTok{plot}\NormalTok{(pred, obs, }\DataTypeTok{xlab =} \StringTok{"Predicción", ylab = "}\NormalTok{Observado}\StringTok{")}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(vivid)}
\NormalTok{fit_rf  <-}\StringTok{ }\KeywordTok{vivi}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ train, }\DataTypeTok{fit =}\NormalTok{ rf, }\DataTypeTok{response =} \StringTok{"taste"}\NormalTok{, }\DataTypeTok{importanceType =} \StringTok{"%IncMSE"}\NormalTok{)}
\KeywordTok{viviHeatmap}\NormalTok{(}\DataTypeTok{mat =}\NormalTok{ fit_rf[}\DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{,}\DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p.est <-}\StringTok{ }\NormalTok{qd.pred}\OperatorTok{$}\NormalTok{posterior}
\end{Highlighting}
\end{Shaded}

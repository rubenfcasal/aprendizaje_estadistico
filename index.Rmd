...
```{r, echo=FALSE, fig.align="right", fig.link="http://hdl.handle.net/2183/37227", out.width="40%", out.extra='style="display: table; float: right; padding-left: 30px; padding-bottom: 10px;"'}

...
Para ajustar un modelo *single index* también se podría emplear la función `npindex()` del paquete  `r citepkg("np","https://github.com/JeffreyRacine/R-Package-np")` (que implementa el método de Ichimura, 1993, considerando un estimador local constante), aunque en este caso ni el tiempo de computación ni el resultado es satisfactorio:
